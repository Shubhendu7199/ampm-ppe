...
app_services = {
  "app-service02-name" = {
    service_plan_id = "/subscriptions/10e0ad56-8242-45e7-b95a-a64f4eb4542f/resourceGroups/rg-wpp-wt-ampm-cartier-ase-01/providers/Microsoft.Web/serverfarms/asp-wpp-wt-ampm-ase-p-cartier-app-service-plan2-name"
    enabled         = true
    https_only      = true
    site_config = {
      always_on          = true
